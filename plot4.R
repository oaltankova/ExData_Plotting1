...
## Construct the plot 4 and save it to a PNG file with a width of 480 pixels and a height of 480 pixels.
print("Load packages")
...
print("Read Data for plot4")
## Read Data for plot1 - all columns
...
gapower$Global_reactive_power <- as.numeric(gapower$Global_reactive_power, na.string = "?")
gapower$Voltage <- as.numeric(gapower$Voltage, na.string = "?")
...
#plot 3
with (gapower, plot(DateTime, Voltage, type="l", 
                    xlab="datetime", ylab="Voltage")
      )

#plot 4
with (gapower, plot(DateTime, Global_reactive_power, type="l", 
